...
namespace WizLib_DataAccess.Migrations
{
    ...
    [Migration("20220608190827_AddRowCategoryToTable")]
    partial class AddRowCategoryToTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WizLib_Model.Models.Fluent_Book", b =>
                {
                    ...
                    b.Property<int>("Fluent_Publisher_Id")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("Fluent_Publisher_Id");
            ...
            modelBuilder.Entity("WizLib_Model.Models.Fluent_BookAuthor", b =>
                {
                    b.Property<int>("Fluent_Author_Id")
                        .HasColumnType("int");

                    b.Property<int>("Fluent_Book_Id")
                        .HasColumnType("int");

                    b.HasKey("Fluent_Author_Id", "Fluent_Book_Id");
            ...
            modelBuilder.Entity("WizLib_Model.Models.Fluent_Book", b =>
                {
                    ...
                    b.HasOne("WizLib_Model.Models.Fluent_Publisher", "Fluent_Publisher")
                        ...
                        .HasForeignKey("Fluent_Publisher_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("WizLib_Model.Models.Fluent_BookAuthor", b =>
                {
                    b.HasOne("WizLib_Model.Models.Fluent_Author", "Fluent_Author")
                        ...
                        .HasForeignKey("Fluent_Author_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
